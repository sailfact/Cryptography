...
const static int S4[4][16] = {
    {7,13,14,3,0,6,10,1,2,8,5,11,12,4,15},
...
class DES
{
    public:
        ...
        bitset<32> permuteStraight(bitset<48> block);
        bitset<48> substitute(bitset<48> block);
